...
// For example, upcase/downcase in Ruby, upper/lower in Python, and toUpperCase/toLowerCase in Java/JavaScript, uppercase/lowercase in Kotlin.
...
// Note: Meta programming is not allowed in this kata. 
// So, the size of your solution is limited.

const STRANGE_STRING = "ß"

function test(str) {
    console.log(str.length) // 1
    console.log(str.toUpperCase().toLowerCase().length) // 2, because "ß" => 'SS' => 'ss'
}
