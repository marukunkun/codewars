...
function  calculateAge(yearOfBirth, yearsToCount) {
	if(yearOfBirth === yearsToCount) {
  	return "You were born this very year!"
  } else if(yearOfBirth < yearsToCount) {
  	let result = yearsToCount - yearOfBirth
  	return `You are ${result} ${result === 1 ? 'year' : 'years'} old.`
  } else {
  	let result = yearOfBirth - yearsToCount
