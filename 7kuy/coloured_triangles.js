...
function triangle(row) {
    while(row.length > 1) {
        ...
        for(let i = 1; i < row.length; i++) {
            if(row[i-1] === 'G' && row[i] === 'G') {
                newRow += 'G'
            } else if(row[i-1] === 'R' && row[i] === 'R') {
                newRow += 'R'
            } else if(row[i-1] === 'B' && row[i] === 'B') {
                newRow += 'B'
            } else if(row[i-1] === 'B' && row[i] === 'G' || row[i-1] === 'G' && row[i] === 'B') {
                newRow += 'R'
            }  else if(row[i-1] === 'R' && row[i] === 'G' || row[i-1] === 'G' && row[i] === 'R') {
                newRow += 'B'
            } else {
                newRow += 'G'
            }
